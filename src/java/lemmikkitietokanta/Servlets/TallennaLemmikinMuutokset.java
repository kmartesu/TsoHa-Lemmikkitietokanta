 ...
 * @author Kim Martesuo
 */
public class TallennaLemmikinMuutokset extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(onKirjautunut(request, response)) {
            ...
            String lemmikinIka = request.getParameter("Ika");
            ...
            if(uusiLemmikkini.onkoKelvollinen()) {
                uusiLemmikkini.paivitaLemmikkiKannassa();   
                request.setAttribute("viesti", "Lemmikki päivitetty onnistuneesti");
            }
            else {
